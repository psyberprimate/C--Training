...
int main() {
    ...
    Account *s2 = new Trust_Account ("Wonderwoman", 5000, 5.0);
    Account *s3 = new Checking_Account("Moe", 2000);
    Account *s4 = new Savings_Account("Porthos", 20000, 4.0);
